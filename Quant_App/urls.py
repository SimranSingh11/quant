...
path('create_new_param',views.create_new_param),
...
path('parammapping',views.getall_paramsmapping,name="parammapping"),
path('new_param',views.add_new_param,name="new_param"),
